	...
	case EItemType::PotionMaterial:
		{
			...
			if (Result.bSuccess)
			{
				...
				{
					auto TableRow = ItemInfo.DataTable->FindRow<FItemMasterInfo>(ItemInfo.RowName,TEXT("GetInventoryItemInfo"),true);
					FPotionMaterial PotionMaterialInfo = UInventoryKitFL::GetItemInfoAsPotionMaterial(*TableRow);
			...
			{
				FPotionMaterial PotionMaterialInfo = UInventoryKitFL::GetItemInfoAsPotionMaterial(*LocInventoryItem);
